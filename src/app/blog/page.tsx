            ...
            <main className="min-h-screen bg-slate-50 pt-32 pb-20">
                <div className="container mx-auto px-6">
                    <header className="mb-16">
                        <h1 className="text-5xl font-black text-slate-900 mb-4 tracking-tighter">Insights <span className="text-blue-600">Industriais</span></h1>
                        <p className="text-slate-500 text-lg">Conhecimento técnico sobre hidráulica, pneumática e engenharia.</p>
                    </header>
